import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.01af844e.js";const h=JSON.parse('{"title":"所有命令","description":"","frontmatter":{},"headers":[],"relativePath":"zh-hans/manage/commands.md","filePath":"zh-hans/manage/commands.md","lastUpdated":1687069487000}'),l={name:"zh-hans/manage/commands.md"},t=e(`<h1 id="所有命令" tabindex="-1">所有命令 <a class="header-anchor" href="#所有命令" aria-label="Permalink to &quot;所有命令&quot;">​</a></h1><p><code>asdf</code> 中所有可用命令的列表。这个列表就是 <code>asdf help</code> 命令的打印内容。</p><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">MANAGE PLUGINS</span></span>
